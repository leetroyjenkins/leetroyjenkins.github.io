    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center py-20">
        ...
        <div className="flex justify-center gap-4 mb-12">
          ...
          <Link
            href="/about"
            className="bg-gray-800 text-white px-8 py-3 rounded-lg hover:bg-gray-900 transition font-semibold shadow-lg hover:shadow-xl"
          >
            My Story
          </Link>
          <Link
      ...
      <div className="py-16 bg-gradient-to-r from-blue-50 to-purple-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['SQL', 'Snowflake', 'dbt', 'Python', 'Terraform', 'Azure', 'Fivetran', 'Git', 'Monte Carlo', 'R'].map((tech) => (
              <span key={tech} className="bg-blue-100 text-blue-800 px-6 py-3 rounded-full font-semibold text-lg shadow-sm">
                {tech}
              </span>
            ))}
          </div>
      ...
      {/* CTA Section */}
      <div className="py-16 text-center bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
        ...
        <Link
          href="/contact"
          className="inline-block bg-blue-600 text-white px-10 py-4 rounded-lg hover:bg-blue-700 transition font-semibold text-lg shadow-lg hover:shadow-xl"
        >
          Let's Talk
        </Link>
      </div>
