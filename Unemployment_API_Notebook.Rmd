...
source("C:/Users/Home/OneDrive/R/Unemployment/BLSAPIKey.R")
```
...
At this point, I have successfully used the API to obtain ten years worth of unemployment data in the `results` tibble. Before I finish, I'd like to add two graphs of the data using the ggplot function.
...
```{r All-US-Territories-Unemployment, fig.cap="US Monthly Unemployment Rate, 2010 - 2021."}
...
```{r Alabama-Unemployment-Data, fig.cap="Alabama Monthly Unemployment Rate, 2010 - 2021."}
