...
1.  Combine datasets into one dataframe based on station Id
    ...
    for (i in unique(raw.air$stationId)) {
      print(i)
    }
    ...
    remove(aq.names, meo.names, temp.names, i)
...
mtext("Sky Conditions by occurence, by season", side = 3, line = 1, cex = 1.5, outer = TRUE)
par(def.par)
...
```{r conditions-by-season-excluding-clear-days}
par(oma = c(3,0,3,2))
par(mar = c(3,5,2,0))
par(mfrow = c(2, 2))
