...
```{r ERD, echo=FALSE, fig.align='left', out.width="100%", fig.height=70, fig.link="images/physicalERD.jpg"}
...
```{r Physical-ERD,  echo=FALSE, fig.align='left', fig.height=70, fig.link="images/physicalERD.jpg"}
knitr::include_graphics("images/PhysicalERD.png")
```
